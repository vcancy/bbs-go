    ...
    <section class="page-container">
        ...
        <el-dialog title="新增" :visible.sync="addFormVisible" :close-on-click-modal="false">
            <el-form :model="addForm" label-width="80px" ref="addForm">
				...
				<el-form-item label="entityType">
					<el-input v-model="addForm.entityType"></el-input>
				</el-form-item>
                
				<el-form-item label="entityId">
  ...
  export default {
    ...
    methods: {
      list() {
        ...
        HttpClient.post('/api/admin/favorite/list', params)
          .then(data => {
      ...
      addSubmit() {
        let me = this
        HttpClient.post('/api/admin/favorite/create', this.addForm)
          .then(data => {
      ...
      handleEdit(index, row) {
        let me = this
        HttpClient.get('/api/admin/favorite/' + row.id)
          .then(data => {
      ...
      editSubmit() {
        let me = this
        HttpClient.post('/api/admin/favorite/update', me.editForm)
          .then(data => {
            me.list()
