...
<template>
    <section class="page-container">
        ...
        <el-table :data="results" highlight-current-row border v-loading="listLoading"
			...
			<el-table-column prop="docUrl" label="docUrl"></el-table-column>
        ...
        <el-dialog title="新增" :visible.sync="addFormVisible" :close-on-click-modal="false">
            <el-form :model="addForm" label-width="80px" ref="addForm">
				...
				<el-form-item label="docUrl">
					<el-input v-model="addForm.docUrl"></el-input>
				</el-form-item>
                
				<el-form-item label="downloadUrl">
        ...
        <el-dialog title="编辑" :visible.sync="editFormVisible" :close-on-click-modal="false">
            <el-form :model="editForm" label-width="80px" ref="editForm">
				...
				<el-form-item label="docUrl">
					<el-input v-model="editForm.docUrl"></el-input>
				</el-form-item>
  ...
  export default {
    ...
    methods: {
      list() {
        ...
        HttpClient.post('/api/admin/project/list', params)
          .then(data => {
      ...
      addSubmit() {
        let me = this
        HttpClient.post('/api/admin/project/create', this.addForm)
          .then(data => {
      ...
      handleEdit(index, row) {
        let me = this
        HttpClient.get('/api/admin/project/' + row.id)
          .then(data => {
      ...
      editSubmit() {
        let me = this
        HttpClient.post('/api/admin/project/update', me.editForm)
          .then(data => {
            me.list()
