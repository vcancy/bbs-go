  ...
  export default {
    ...
    methods: {
      list() {
        ...
        HttpClient.post('/api/admin/user-token/list', params)
          .then(data => {
      ...
      addSubmit() {
        let me = this
        HttpClient.post('/api/admin/user-token/create', this.addForm)
          .then(data => {
      ...
      handleEdit(index, row) {
        let me = this
        HttpClient.get('/api/admin/user-token/' + row.id)
          .then(data => {
      ...
      editSubmit() {
        let me = this
        HttpClient.post('/api/admin/user-token/update', me.editForm)
          .then(data => {
            me.list()
