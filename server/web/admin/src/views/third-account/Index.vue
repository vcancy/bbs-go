...
<template>
    <section class="page-container">
        ...
        <el-table :data="results" highlight-current-row border v-loading="listLoading"
			...
			<el-table-column prop="thirdType" label="thirdType"></el-table-column>
            
			<el-table-column prop="thirdId" label="thirdId"></el-table-column>
        ...
        <el-dialog title="新增" :visible.sync="addFormVisible" :close-on-click-modal="false">
            <el-form :model="addForm" label-width="80px" ref="addForm">
				...
				<el-form-item label="thirdType">
					<el-input v-model="addForm.thirdType"></el-input>
				</el-form-item>
                
				<el-form-item label="thirdId">
					<el-input v-model="addForm.thirdId"></el-input>
				</el-form-item>
        ...
        <el-dialog title="编辑" :visible.sync="editFormVisible" :close-on-click-modal="false">
            <el-form :model="editForm" label-width="80px" ref="editForm">
				...
				<el-form-item label="thirdType">
					<el-input v-model="editForm.thirdType"></el-input>
				</el-form-item>
                
				<el-form-item label="thirdId">
					<el-input v-model="editForm.thirdId"></el-input>
				</el-form-item>
  ...
  export default {
    ...
    methods: {
      list() {
        ...
        HttpClient.post('/api/admin/third-account/list', params)
          .then(data => {
      ...
      addSubmit() {
        let me = this
        HttpClient.post('/api/admin/third-account/create', this.addForm)
          .then(data => {
      ...
      handleEdit(index, row) {
        let me = this
        HttpClient.get('/api/admin/third-account/' + row.id)
          .then(data => {
      ...
      editSubmit() {
        let me = this
        HttpClient.post('/api/admin/third-account/update', me.editForm)
          .then(data => {
            me.list()
