...
<template>
    <section class="page-container">
        ...
        <el-table :data="results" highlight-current-row border v-loading="listLoading"
			...
			<el-table-column prop="fromId" label="fromId"></el-table-column>
            
			<el-table-column prop="userId" label="userId"></el-table-column>
            
			<el-table-column prop="content" label="content"></el-table-column>
            
			<el-table-column prop="quoteContent" label="quoteContent"></el-table-column>
        ...
        <el-dialog title="新增" :visible.sync="addFormVisible" :close-on-click-modal="false">
            <el-form :model="addForm" label-width="80px" ref="addForm">
				...
				<el-form-item label="fromId">
					<el-input v-model="addForm.fromId"></el-input>
				</el-form-item>
				...
				<el-form-item label="quoteContent">
					<el-input v-model="addForm.quoteContent"></el-input>
				</el-form-item>
        ...
        <el-dialog title="编辑" :visible.sync="editFormVisible" :close-on-click-modal="false">
            <el-form :model="editForm" label-width="80px" ref="editForm">
				...
				<el-form-item label="fromId">
					<el-input v-model="editForm.fromId"></el-input>
				</el-form-item>
				...
				<el-form-item label="quoteContent">
					<el-input v-model="editForm.quoteContent"></el-input>
				</el-form-item>
