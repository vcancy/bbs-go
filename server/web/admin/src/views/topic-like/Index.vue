  ...
  export default {
    ...
    methods: {
      list() {
        ...
        HttpClient.post('/api/admin/topic-like/list', params)
          .then(data => {
      ...
      addSubmit() {
        let me = this
        HttpClient.post('/api/admin/topic-like/create', this.addForm)
          .then(data => {
      ...
      handleEdit(index, row) {
        let me = this
        HttpClient.get('/api/admin/topic-like/' + row.id)
          .then(data => {
      ...
      editSubmit() {
        let me = this
        HttpClient.post('/api/admin/topic-like/update', me.editForm)
          .then(data => {
            me.list()
