  ...
  export default {
    ...
    methods: {
      list() {
        ...
        HttpClient.post('/api/admin/sys-config/list', params)
          .then(data => {
      ...
      addSubmit() {
        let me = this
        HttpClient.post('/api/admin/sys-config/create', this.addForm)
          .then(data => {
      ...
      handleEdit(index, row) {
        let me = this
        HttpClient.get('/api/admin/sys-config/' + row.id)
          .then(data => {
      ...
      editSubmit() {
        let me = this
        HttpClient.post('/api/admin/sys-config/update', me.editForm)
          .then(data => {
            me.list()
