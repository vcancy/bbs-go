...
<template>
    <section class="page-container">
        ...
        <el-table :data="results" highlight-current-row border v-loading="listLoading"
			...
			<el-table-column prop="commentCount" label="commentCount"></el-table-column>
            
			<el-table-column prop="likeCount" label="likeCount"></el-table-column>
            
			<el-table-column prop="status" label="status"></el-table-column>
            
			<el-table-column prop="lastCommentTime" label="lastCommentTime"></el-table-column>
        ...
        <el-dialog title="新增" :visible.sync="addFormVisible" :close-on-click-modal="false">
            <el-form :model="addForm" label-width="80px" ref="addForm">
				...
				<el-form-item label="viewCount">
					<el-input v-model="addForm.viewCount"></el-input>
				</el-form-item>
                
				<el-form-item label="commentCount">
					<el-input v-model="addForm.commentCount"></el-input>
				</el-form-item>
                
				<el-form-item label="likeCount">
					<el-input v-model="addForm.likeCount"></el-input>
				</el-form-item>
				...
				<el-form-item label="lastCommentTime">
					<el-input v-model="addForm.lastCommentTime"></el-input>
				</el-form-item>
        ...
        <el-dialog title="编辑" :visible.sync="editFormVisible" :close-on-click-modal="false">
            <el-form :model="editForm" label-width="80px" ref="editForm">
				...
				<el-form-item label="commentCount">
					<el-input v-model="editForm.commentCount"></el-input>
				</el-form-item>
                
				<el-form-item label="likeCount">
					<el-input v-model="editForm.likeCount"></el-input>
				</el-form-item>
				...
				<el-form-item label="lastCommentTime">
					<el-input v-model="editForm.lastCommentTime"></el-input>
				</el-form-item>
